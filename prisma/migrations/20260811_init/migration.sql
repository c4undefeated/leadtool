...
CREATE TABLE "EngagementRecommendation" (
    ...
    CONSTRAINT "EngagementRecommendation_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "DMDraft" (
    ...
    CONSTRAINT "DMDraft_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Opportunity" ADD CONSTRAINT "Opportunity_conversationId_fkey" FOREIGN KEY ("conversationId") REFERENCES "Conversation"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EngagementRecommendation" ADD CONSTRAINT "EngagementRecommendation_opportunityId_fkey" FOREIGN KEY ("opportunityId") REFERENCES "Opportunity"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CommentDraft" ADD CONSTRAINT "CommentDraft_engagementRecommendationId_fkey" FOREIGN KEY ("engagementRecommendationId") REFERENCES "EngagementRecommendation"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DMDraft" ADD CONSTRAINT "DMDraft_engagementRecommendationId_fkey" FOREIGN KEY ("engagementRecommendationId") REFERENCES "EngagementRecommendation"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
